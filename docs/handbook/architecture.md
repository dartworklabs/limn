...
| [`src/limn/documents.py`](../../src/limn/documents.py) | 17 | 여러 문서의 조회 결과 값: 없는 문서 키(`DocNotFound`, 이 인스턴스의 키 목록과 함께) |
